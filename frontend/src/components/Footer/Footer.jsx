      ...
      <Container>
        <Row>
          <Col lg='3'>
           <div className='logo'>
            <img src={logo} alt="" />
            <p>Thank you for booking your family tour with us</p>
           ...
           <h5 className='footer_link-title'>Contact</h5>
            ...
            <ListGroup className='footer_quick-links'>
                ...
                align-item-center gap-3'>
                  ...
                  <p className='mb-0'>Sahabganj, Ayodhya</p>
                </ListGroupItem>
                <ListGroupItem  className='ps-0 border-0 d-flex 
                align-item-center gap-3'>
                  ...
                  <p className='mb-0'>sa7861727@gmail.com</p>
                </ListGroupItem>
                <ListGroupItem  className='ps-0 border-0 d-flex 
                align-item-center gap-3'>
                  ...
                  <p className='mb-0'>+919682776959</p>
                </ListGroupItem>
          ...
          <p className='copyright'>Copyright {year}, design and developed by
            Sameer Ahmad. All rights reserved.
          </p>
          </Col>
        </Row>
      </Container>
